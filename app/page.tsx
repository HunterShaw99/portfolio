    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-white">
                ...
                <div className="max-w-6xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex space-x-8">
                            <a href="#about"
                               className="text-gray-400 hover:text-white transition-colors text-sm font-medium">About</a>
                            <a href="#experience"
                               className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Experience</a>
                            <a href="#skills"
                               className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Skills</a>
                            <a href="#contact"
                               className="text-gray-400 hover:text-white transition-colors text-sm font-medium">Contact</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            <p className="text-lg text-gray-300 leading-relaxed">
                                I&#39;m a passionate software engineer with over 3 years of experience developing
                        ...
                        {workExperience.map((job, index) => (
                            <div key={index} className="card">
                                <div className="mb-8">
                                    ...
                                    {job.summary && (
                                        <span className="text-lg text-gray-400 italic leading-relaxed">{job.summary}</span>
                                    )}
                                </div>
                                <div className="space-y-5">
                                    {job.responsibilities.map((responsibility, idx) => (
                                        <div key={idx} className="flex items-start text-gray-300 leading-relaxed">
                                            <span
                                                className="w-1.5 h-1.5 bg-gray-500 rounded-full mr-4 mt-2 flex-shrink-0"></span>
            ...
            <section id="skills" className="py-24 px-6">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center gradient-text-accent">Skills &
                        Technologies</h2>
                ...
                {skill}
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="card text-center">
                            ...
                            <p className="text-gray-400 leading-relaxed">React, JavaScript, TypeScript, HTML5, CSS3,
                                Responsive Design</p>
                        </div>
                        <div className="card text-center">
                            <h3 className="text-xl font-semibold mb-4 text-white">Backend</h3>
                            <p className="text-gray-400 leading-relaxed">Express, FastAPI, Python, Next.JS, REST APIs,
                                PL/SQL, Database Design</p>
                        </div>
                        <div className="card text-center">
                            <h3 className="text-xl font-semibold mb-4 text-white">Cloud & DevOps</h3>
                            <p className="text-gray-400 leading-relaxed">AWS (EC2, S3, RDS), Digital Ocean,<br/>Linux/Unix,
                                Containerization, Git</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="contact" className="py-16 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6 max-w-2xl mx-auto px-4 sm:px-0">
                        ...
                        >
                            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform "><BriefcaseIcon
                                className={'w-10 h-10 items-center justify-center'}/></div>
                            <h3 className="text-lg font-semibold text-white mb-2">LinkedIn</h3>
                            <p className="text-gray-400 group-hover:text-gray-300 transition-colors text-center px-2">Connect
                                with me</p>
                        </a>
                    </div>
                </div>
